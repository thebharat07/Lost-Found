...
// Helpers
const readData = () => fs.existsSync(NOTIFICATIONS_FILE) ? JSON.parse(fs.readFileSync(NOTIFICATIONS_FILE)) : [];
const writeData = (data) => fs.writeFileSync(NOTIFICATIONS_FILE, JSON.stringify(data, null, 2));
